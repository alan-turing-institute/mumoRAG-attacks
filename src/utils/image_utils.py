...
def load_gpt_image(task_config: "TaskConfig") -> torch.tensor:
    if task_config.is_targeted:
        gpt_filename = f"attack-gpt-targeted-ret-gen-q{task_config.target_query_idx[0]}.png"
    else:
        gpt_filename = "attack-gpt-universal-ret-gen.png"
    filename = DATA_FOLDER / "attacks" / "gpt-attacks" / gpt_filename
    try:
