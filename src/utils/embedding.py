...
def score_multi_vector_modified(
        ...
        """
        NOTE: this is amodified version of Colpali's scoring function at https://github.com/illuin-tech/colpali/blob/main/colpali_engine/utils/processing_utils.py
        """
