...
class MetricIdx(IntEnum):
    RETRIEVAL_RECALL1_BEFORE = auto()
    RETRIEVAL_RECALL1_AFTER = auto()
    RETRIEVAL_ASR1_TRAIN = auto()
    RETRIEVAL_ASR1_TEST = auto()
    RETRIEVAL_RECALL5_BEFORE = auto()
    RETRIEVAL_RECALL5_AFTER = auto()
    RETRIEVAL_ASR5_TRAIN = auto()
    RETRIEVAL_ASR5_TEST = auto()
    GENERATION_ASR_EXACT_TRAIN = auto()
    GENERATION_ASR_EMBED_TRAIN = auto()
    GENERATION_ASR_EXACT_TEST = auto()
    GENERATION_ASR_EMBED_TEST = auto()
